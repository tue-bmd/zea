...
def test_decode_hadamard():
    ...
    tx = n_el // 2
    viewer.add_image(np.abs(raw_data_encoded[0, tx, :, :, 0]), name="encoded", colormap="viridis")
    viewer.add_image(np.abs(raw_data_decoded[0, tx, :, :, 0]), name="decoded", colormap="viridis")
    viewer.add_image(
        np.abs(raw_data_synthetic_aperture[0, tx, :, :, 0]),
