...
.. code-block:: bash
    ...
    zea -c configs/config_picmus_rf.yaml -t generate
...
from zea.utils import get_function_args
...
class GenerateDataSet:
    ...
    def save_data(self, data, path, scan_parameters, probe_name, description):
        ...
        # automatically get correct gen_kwargs for generate_zea_dataset function
