...
from zea.internal.core import STATIC, Object
...
class Scan(Parameters):
    ...
    Args:
        ...
        lens_thickness (float, optional): Thickness of the lens in meters. Defaults to None.
...
#         `pixels_per_wavelength` parameter. See `zea.beamform.pixelgrid.get_grid`.
#         """
