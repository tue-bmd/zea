...
class Scan(Parameters):
    ...
    VALID_PARAMS = {
        ...
        "grid_size_x": {"type": (int, np.integer, np.ndarray), "default": None},
        "grid_size_z": {"type": (int, np.integer, np.ndarray), "default": None},
        ...
        "polar_limits": {"type": (tuple, list, np.ndarray), "default": None},
        "dynamic_range": {"type": (tuple, list, np.ndarray), "default": DEFAULT_DYNAMIC_RANGE},
        ...
        "element_width": {"type": (float, np.ndarray), "default": None},
