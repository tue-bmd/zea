...
class Simulate(Operation):
    ...
    ``elevation_focus``, ``lens_attenuation_coef``, ``band_db``, ``n_fft``) reach the
    ...
    simulator its own default. ``element_height`` (both simulators) defaults to an eighth of
    the width of a 1D probe.
