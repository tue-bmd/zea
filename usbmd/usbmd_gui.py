...
class USBMDApp(App):
    ...
    def __init__(self, ui=None, resolution=None, title=None, verbose=False):
        super().__init__(config_schema, resolution, title, button=False, verbose=verbose)
        self.ui = ui
        if self.ui:
            self.ui.gui = self
        ...
        # Styling
        self.style.configure("ButtonFrame.TFrame",
    ...
    def build(self, data):
        ...
        self.user_label = ttk.Label(
            self, text=self.user_text, style="Footer.TLabel")
    ...
    def build_right_panel(self):
        ...
        self.freeze_button = ttk.Button(button_frame, text='Freeze', command=self.freeze)
