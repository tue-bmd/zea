...
# Keys documented in PARAMETER_DESCRIPTIONS that are deprecated aliases and thus
# intentionally absent from the config spec (see _migrate_legacy_config).
DEPRECATED_KEYS = {"scan"}
...
def check_parameter_descriptions(descriptions, spec):
    ...
    extra = sorted(rst_keys - schema_keys - DEPRECATED_KEYS)
...
def create_parameters_rst(param_dict, rst_path=PARAMETERS_RST_PATH):
    ...
    intro = """.. THIS FILE WAS AUTOGENERATED USING docs/source/parameters_doc.py. DO NOT EDIT MANUALLY.
